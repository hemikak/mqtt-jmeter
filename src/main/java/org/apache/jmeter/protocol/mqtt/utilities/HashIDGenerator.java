...
public class HashIDGenerator {
    ...
    public HashIDGenerator(String salt) {
        this(salt, 0);
    }

    public HashIDGenerator(String salt, int minHashLength) {
        this(salt, minHashLength, DEFAULT_ALPHABET);
    }

    public HashIDGenerator(String salt, int minHashLength, String alphabet) {
    ...
    private String encode(long[] numbers, String alphabet, String salt, int minHashLength) {
        ...
        if (ret.length() < minHashLength) {
            ...
            if (guardIndex < 0){
                guardIndex = Math.abs(guardIndex);
            }
