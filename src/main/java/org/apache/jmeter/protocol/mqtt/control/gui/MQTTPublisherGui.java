...
public class MQTTPublisherGui extends AbstractSamplerGui implements
    ...
    private final JLabeledRadioI18N destSetup = new JLabeledRadioI18N("mqtt_dest_setup", DEST_SETUP_ITEMS,
    ...
    private final JLabeledTextField urlField = new JLabeledTextField(JMeterUtils.getResString("mqtt_provider_url"));
    //$NON-NLS-1$
    ...
    //$NON-NLS-1$
    private final JLabeledTextField iterations = new JLabeledTextField(JMeterUtils.getResString("mqtt_itertions"));
    //$NON-NLS-1$
    private final JSyntaxTextArea textMessage = new JSyntaxTextArea(10, 50); // $NON-NLS-1$
    private final JLabeledRadioI18N msgChoice = new JLabeledRadioI18N("mqtt_message_type", MSGTYPES_ITEMS,
		    TEXT_MSG_RSC); //$NON-NLS-1$
    private final JLabeledRadioI18N msgFormat = new JLabeledRadioI18N("mqtt_message_format", MSGFORMAT_ITEMS,
		    NO_ENCODING); //$NON-NLS-1$
    private final JCheckBox connectionPerTopic = new JCheckBox(JMeterUtils.getResString("mqtt_connection_per_topic"),
		    false); // $NON-NLS-1$
    // For messages content
    private final JCheckBox useTimeStamp = new JCheckBox(JMeterUtils.getResString("mqtt_use_time_stamp"), false); //
    // $NON-NLS-1$
    private final JCheckBox useNumberSeq = new JCheckBox(JMeterUtils.getResString("mqtt_use_number_seq"), false); //
    // $NON-NLS-1$
    private final JCheckBox isRetained = new JCheckBox(JMeterUtils.getResString("mqtt_send_as_retained_msg"), false);
     // $NON-NLS-1$
    private final JLabeledRadioI18N typeQoSValue = new JLabeledRadioI18N("mqtt_qos", QTYPES_ITEMS, AT_MOST_ONCE);
    //$NON-NLS-1$
    private final JLabeledRadioI18N typeGeneratedValue = new JLabeledRadioI18N("mqtt_type_of_generated_value",
		    VALTYPES_ITEMS, INT); //$NON-NLS-1$
    private final JLabeledRadioI18N typeFixedValue = new JLabeledRadioI18N("mqtt_type_of_fixed_value",
		    FVALTYPES_ITEMS, INT); //$NON-NLS-1$
    private final JLabeledTextField min = new JLabeledTextField(JMeterUtils.getResString("mqtt_min_value"));
    //$NON-NLS-1$
    private final JLabeledTextField max = new JLabeledTextField(JMeterUtils.getResString("mqtt_max_value"));
    //$NON-NLS-1$
    private final JLabeledTextField value = new JLabeledTextField(JMeterUtils.getResString("mqtt_value")); //$NON-NLS-1$
    private final JLabeledRadioI18N typeRandom = new JLabeledRadioI18N("mqtt_type_random", RANTYPES_ITEMS, PSEUDO);
    //$NON-NLS-1$
    private final JLabeledTextField seed = new JLabeledTextField(JMeterUtils.getResString("mqtt_seed_random"));
    //$NON-NLS-1$
    ...
    //$NON-NLS-1$
    private JComboBox<String> CharsetChooser = new JComboBox<String>(new String[]{"UTF-8", "UTF-16", "US-ASCII",
                                                                                  "UTF-16BE", "UTF-16LE",
                                                                                  "ISO-8859-1"});
    private final JLabeledTextField sizeArray = new JLabeledTextField(JMeterUtils.getResString("mqtt_size_array"));
    //$NON-NLS-1$
