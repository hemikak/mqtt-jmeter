...
public class SimpleAsyncWaitClient implements BaseClient {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            SimpleAsyncWaitClient sampleClient = new SimpleAsyncWaitClient(url,clientId,cleanSession, quietMode,userName,password);

            // Perform the specified action
            if (action.equals("publish")) {
                sampleClient.publish(topic,qos,message.getBytes(), false);
     ...
     */
    public SimpleAsyncWaitClient(String brokerUrl, String clientId, boolean cleanSession,
