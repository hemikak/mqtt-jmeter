 ...
 */
public class SimpleClient implements BaseClient {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            SimpleClient simpleClientClient = new SimpleClient(url, clientId, cleanSession, quietMode,userName,password);

            // Perform the requested action
            if (action.equals("publish")) {
                simpleClientClient.publish(topic,qos,message.getBytes(), false);
            } else if (action.equals("subscribe")) {
                simpleClientClient.subscribe(topic,qos);
            }
     ...
     */
    public SimpleClient(String brokerUrl, String clientId, boolean cleanSession, boolean quietMode, String userName,
